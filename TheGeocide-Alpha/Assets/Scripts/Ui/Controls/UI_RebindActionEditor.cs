...
namespace Assets.Scripts.Ui.Controls
{
    ...
    /// </summary>
    [CustomEditor(typeof(UI_RebindAction))]
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        protected void OnEnable()
        {
            ...
            m_RebindColorProperty = serializedObject.FindProperty("m_RebindColor");
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                ...
                EditorGUILayout.PropertyField(m_RebindColorProperty);
        ...
        private SerializedProperty m_RebindColorProperty;
